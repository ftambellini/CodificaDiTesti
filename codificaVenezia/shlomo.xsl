...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tei="http://www.tei-c.org/ns/1.0">
    ...
    <xsl:template match="//tei:text[@type='source']/tei:body/tei:div/tei:u/tei:lb">
		<br />
    </xsl:template>
    ...
    <xsl:template match="//tei:rs[@type='place']">
    	<span class="riferimentoPosto" style="border:2px solid red"><xsl:value-of select="."/></span>
    </xsl:template>
	<xsl:template match="//tei:rs[@type='person']">
    	<span class="riferimentoPersona" style="border:2px solid blue"><xsl:value-of select="."/></span>
    </xsl:template>
</xsl:stylesheet>